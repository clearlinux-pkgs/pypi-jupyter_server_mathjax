...
%prep
%setup -q -n jupyter_server_mathjax-0.2.5
cd %{_builddir}/jupyter_server_mathjax-0.2.5
pushd ..
cp -a jupyter_server_mathjax-0.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653340612
...
cp %{_builddir}/jupyter_server_mathjax-0.2.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_server_mathjax/4a3ccb8c03802d2981db7856c534491a854e6741
cp %{_builddir}/jupyter_server_mathjax-0.2.5/jupyter_server_mathjax/static/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyter_server_mathjax/2b8b815229aa8a61e483fb4ba0588b8b6c491890
